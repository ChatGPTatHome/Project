 ...
 * This class tests various functionalities of the CostTab class, ensuring
 * correct handling
 * of budget initialization, updating, and cost management through a series of
 * unit tests.
 *
 * @author Windie Le
 */
public class CostTabTest {
     ...
     * Verifies that the default budget is set to zero and no cost sources are added
     * initially.
     * 
     * @author Windie Le
     */
    ...
    /**
     * Test getKey method.
     * Verifies that the method returns the correct key associated with the CostTab
     * class.
     * 
     * @author Windie Le
     */
     ...
     * Verifies that the total cost is calculated correctly after adding multiple
     * cost sources.
     * 
     * @author Windie Le
     */
     ...
     * Verifies that the remaining budget is computed correctly by subtracting the
     * total cost from the budget.
     * 
     * @author Windie Le
     */
    @Test
     ...
     * Verifies that the budget is correctly set through the instantiate method
     * using a data map.
     * 
     * @author Windie Le
     */
